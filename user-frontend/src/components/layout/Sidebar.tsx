...
const navItems = [
  ...
  { path: '/meetings', icon: 'meetings', label: '会议' },
  { path: '/favorites', icon: 'favorites', label: '收藏' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-20 bg-slate-900 border-r border-slate-700/50 flex flex-col items-center py-4">
      {/* Logo */}
      <div className="mb-8">
      ...
      <div className="mt-auto flex flex-col items-center space-y-4">
        ...
        <div className="relative">
          <Avatar name={user?.username} size="md" status="online" />
        </div>
      </div>
    </aside>
  )
